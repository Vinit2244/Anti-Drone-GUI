...
export interface RContextType {
    ...
    readonly vectorlayer?: BaseVector<SourceVector<Geometry>, CanvasVectorLayerRenderer | CanvasVectorTileLayerRenderer | CanvasVectorImageLayerRenderer | WebGLPointsLayerRenderer>;
