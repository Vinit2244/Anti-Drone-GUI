 ...
 */
var RLayerBaseVector = /** @class */ (function (_super) {
    ...
    function RLayerBaseVector(props, context) {
        ...
        _this.eventRelay = function (e) {
            if (_this.props['on' + RLayerBaseVector.relayedEvents[e.type]])
                return (_this.props['on' + RLayerBaseVector.relayedEvents[e.type]].call(_this, e) !== false);
            return true;
        };
        RFeature_1.default.initEventRelay(_this.context.map);
        _this.eventSources = _this.createSource(props);
        _this.source.on('featuresloadend', _this.newFeature);
        _this.source.on('addfeature', _this.newFeature);
        _this.attachEventHandlers();
        return _this;
    }
    RLayerBaseVector.prototype.createSource = function (props) {
    ...
    RLayerBaseVector.prototype.render = function () {
        return (react_1.default.createElement("div", { className: '_rlayers_RLayerVector' },
            react_1.default.createElement(context_1.RContext.Provider, { value: __assign(__assign({}, this.context), { layer: this.ol, source: this.source, vectorlayer: this.ol, vectorsource: this.source }) }, this.props.children)));
    };
