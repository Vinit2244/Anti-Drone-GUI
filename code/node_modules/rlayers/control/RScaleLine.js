 ...
 */
var RScaleLine = /** @class */ (function (_super) {
    ...
    RScaleLine.prototype.toOLProps = function (props) {
        var _a;
        return __assign(__assign({}, _super.prototype.toOLProps.call(this, props)), { minWidth: props.minWidth, bar: props.bar, text: props.text, units: (_a = props.units) !== null && _a !== void 0 ? _a : 'metric' });
    };
    return RScaleLine;
