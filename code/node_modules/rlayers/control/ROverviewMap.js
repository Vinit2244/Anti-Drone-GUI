 ...
 */
var ROverviewMap = /** @class */ (function (_super) {
    ...
    ROverviewMap.prototype.toOLProps = function (props) {
        return __assign(__assign({}, _super.prototype.toOLProps.call(this, props)), { collapsible: props.collapsible, collapsed: props.collapsed, label: props.label, collapseLabel: props.collapseLabel });
    };
    ROverviewMap.prototype.refresh = function (prevProps) {
